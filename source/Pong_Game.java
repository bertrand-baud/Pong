...
public void setup() { 
  ...
  int song_number = PApplet.parseInt(random(main_level_music_file.length));
...
public void draw() {
  ...
  if( ( yBall >= paddle_elevation ) && ( yBall < paddle_elevation + ball_speed) && ( xBall >= paddle_left_pos ) && (xBall <= paddle_left_pos + paddle_width ) && ( game_over == false ) ) {
    ...
    float distance_from_paddle_center = (xBall - (paddle_left_pos + (paddle_width/2.0f)));
...
public void mouseClicked() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Pong_Game" };
    if (passedArgs != null) {
